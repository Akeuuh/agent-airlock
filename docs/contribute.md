...
threat model in mind** ([`architecture.md`](architecture.md)).
...
2. **Make changes** following the [“where does my change go” table](README.md#-where-does-my-change-go-and-how-do-i-apply-it)
...
| Contribution | Guide |
|---|---|
| MCP server | [`add-mcp.md`](add-mcp.md) |
| Skill | [`add-skill.md`](add-skill.md) |
| Slash-command / plugin | [`add-command.md`](add-command.md) |
| Egress domain | [`egress-allowlist.md`](egress-allowlist.md) |
| Build / images / registry | [`build-and-images.md`](build-and-images.md) |
